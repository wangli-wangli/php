...
if(isset($_GET['id'])) {
    ...
    ?>
    <form action="ex02d.php" method="get">
        <table border="2" align="center">
            ...
            foreach ($attr as $v) {
                ...
                <tr>
                    ...
                    <td><input type="text" name="age" value="<?php echo $v[3]; ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea cols="40" rows="3" name="hobby"> <?php echo $v[5]; ?></textarea>
                    </td>
                </tr>
            <?php } ?>
            <tr>
...
if(isset($_GET['id2'])) {
    ...
    $password = "root";
    $database = "php_database";
    $sql2 = "update student set  name='" . $name . "',sex='" . $sex . "',age='" . $age . "',address='" . $address . "',hobby='" . $hobby . "' where id=" . $id2 ."";
    echo $sql2;
    if (($connID = mysqli_connect($host, $userName, $password, $database))) {
